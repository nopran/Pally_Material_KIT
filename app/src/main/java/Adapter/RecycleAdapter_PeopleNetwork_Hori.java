 ...
 */
public class RecycleAdapter_PeopleNetwork_Hori extends RecyclerView.Adapter<RecycleAdapter_PeopleNetwork_Hori.MyViewHolder> {
Context context;
    ...
    public RecycleAdapter_PeopleNetwork_Hori(Context mainActivityContacts, List<BeanClassForHomeJobNetwork> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_people_network_list, parent, false);
